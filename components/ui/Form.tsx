...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Label
      ref={ref}
      className={cn('pt-1.5', error && 'text-destructive', className)}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Text
      ...
      className={cn('text-sm text-muted-foreground pt-0', className)}
      {...props}
    />
  );
});
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <Text
      ...
      className={cn('text-xs font-medium text-red-600 pt-0.5', className)}
      {...props}>
      {body}
    </Text>
  );
